...
namespace ArbolService.Controllers
{
    ...
    public class ValuesController : ApiController
    {
        ...
        [Route("api/listaJobs")]
        [HttpGet]
        public IHttpActionResult Jobs_lista()
        {
            try
            {
                List<Jobs> lista = new List<Jobs>();
                daJerarquia = new DaJerarquia(dalConnection);
                lista = daJerarquia.ObtenerListaJobsT();
        ...
        // Sucesores Totales
        [Route("api/SucesoresT")]
        [HttpGet]
        public IHttpActionResult SucesoresT([FromUri] string job)
        {
            try
            {
                List<RelacionMallas> lista = new List<RelacionMallas>();
                daJerarquia = new DaJerarquia(dalConnection);
                lista = daJerarquia.ObtenerListaSucesoresT(job);
                RelacionMallas rl = new RelacionMallas();
                rl.Parent = job;
                rl.Child = "";
                lista.Add(rl);
        ...
        // Predecesores Totales
        [Route("api/PredecesoresT")]
        [HttpGet]
        public IHttpActionResult PredecesoresT([FromUri] string job)
        {
            try
            {
                List<RelacionMallas> lista = new List<RelacionMallas>();
                daJerarquia = new DaJerarquia(dalConnection);
                lista = daJerarquia.ObtenerListaPredecesoresT(job);
                RelacionMallas rl = new RelacionMallas();
                rl.Parent = job;
                rl.Child = "";
                lista.Add(rl);
        ...
        // Lista de Jobs
        [Route("api/listaJobsAutoComplete")]
        [HttpGet]
        public IHttpActionResult Jobs_listaAuto([FromUri] String jobA)
        {
            try
            {
                List<Jobs> lista = new List<Jobs>();
                daJerarquia = new DaJerarquia(dalConnection);
                lista = daJerarquia.ListaJobsAutoComplete(jobA);
